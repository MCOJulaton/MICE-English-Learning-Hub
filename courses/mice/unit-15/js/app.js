...
const CHECKIN_STORAGE_KEY = 'mice_u15_checkin';
...
/* ===================== VOICE ENGINE =====================
   Two named characters: Fern (event coordinator, default British female
...
function renderS1(){
  ...
  <h2 class="section-title">One Guest, One Whole Journey</h2>
  ...
  <div class="panel">
    ...
    <p class="section-sub" style="margin-top:4px;">Before you build the journey yourself, listen to today's overview of its stages. Fill in the table as you listen, then reveal the answers to check yourself.</p>
    ...
    <hr class="hairline">
    <h3 style="font-size:16px;color:var(--navy);">Everything You've Learned, One Journey</h3>
    <p style="color:var(--ink);margin-top:8px;line-height:1.6;font-size:14.5px;">This is the final unit before the real final exam. It doesn't teach a brand new skill, it asks you to combine every skill from Units 9 to 14 into one connected, original piece of work: a guest's whole journey, designed by you.</p>
  </div>`;
}
function wireS1(){
...
function renderS2(){
  ...
  <p class="section-sub">These 10 words come up again and again in this unit. Click a word to see it used in a real journey-design situation.</p>
  <div class="panel">
...
function renderS2b(){
  ...
  <p class="section-sub">The client's notes are all mixed together. Sort each one into the journey stage it belongs to.</p>
  <div class="panel">
    ${cards}
...
function renderS4(){
  ...
  <h2 class="section-title">Reading: Designing the Complete Guest Journey</h2>
...
function renderS5(){
  ...
  <p class="section-sub">The phrases event professionals use across the whole guest journey.</p>
  <div class="panel">
...
function renderS6(){
  ...
  <h2 class="section-title">Listening: Planning the Journey</h2>
  ...
  <div class="panel">
    <div class="playbar">
      ...
      <div style="flex:1;min-width:180px;">
        ...
        <div class="play-sub" id="s6status">Fern and Beam plan Mr. Larsson's journey.</div>
      </div>
  ...
  VoiceEngine.onChange(()=>{
    ...
    if(statusEl){
      statusEl.textContent = isPlaying
        ...
        : "Fern and Beam plan Mr. Larsson's journey.";
    }
    if(playBtn){
      playBtn.innerHTML = isPlaying ? icon('stop',{size:20}) : icon('play',{size:20});
      playBtn.title = isPlaying ? 'Stop' : 'Play';
...
function renderS7(){
  ...
  <div class="panel">
    ...
    <p style="color:var(--muted);font-size:13px;margin-top:4px;">These are real strategies used by professional event coordinators worldwide. Click each one once you can point to where it happened in the call.</p>
...
/* ===== Section 6b: Build the Journey =====
   ...
   a full model journey. This is Unit 15's distinct mechanic and the
...
function renderPractice(){
  ...
  <div class="panel">
    <h3 style="font-size:15px;color:var(--navy);">Bonus: Design Another Journey</h3>
...
function renderS10(){
  ...
  <div class="panel">
    ${rows}
    <hr class="hairline">
    <p style="font-family:'Oswald';color:var(--navy);font-size:15px;letter-spacing:.03em;">You've now practiced applying, analyzing, evaluating, and creating original MICE English across Units 9 to 15. Well done.</p>
  </div>`;
}
function wireS10(){
...
function renderComplete(){
  ...
  <div class="cover complete-cover">
    ...
    <h1>You can <span>design the whole journey.</span></h1>
    <p>You've reached the end of the Units 9-15 series. Keep practicing personalizing every message, and remember: it's one connected journey, not separate tasks.</p>
