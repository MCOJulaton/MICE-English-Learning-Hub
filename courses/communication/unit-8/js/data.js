...
const VOCAB = [
  {id:'modern', ic:'🏙️', nm:'Modern', type:'adj.', def:'New and up to date, not old-fashioned.', ex:'That is a very modern shopping mall.'},
  {id:'outdoors', ic:'🌳', nm:'Outdoors', type:'adv.', def:'Outside, not inside a building.', ex:'I love spending my free time outdoors.'},
  {id:'crowded', ic:'👥', nm:'Crowded', type:'adj.', def:'Full of many people.', ex:'The night market gets very crowded on weekends.'},
  {id:'provide', ic:'🎁', nm:'Provide', type:'v.', def:'To give someone something they need.', ex:'The park provides free bikes for visitors.'},
  {id:'nature', ic:'🍃', nm:'Nature', type:'n.', def:'The outdoor world of plants, animals, and land, away from cities.', ex:'She feels calm whenever she is close to nature.'},
  {id:'scene', ic:'🎭', nm:'Scene', type:'n.', def:'The general feeling or atmosphere of a place.', ex:'The coffee shop has a relaxing scene in the evening.'},
  {id:'relaxing', ic:'😌', nm:'Relaxing', type:'adj.', def:'Making you feel calm, not stressed.', ex:'Reading before bed is relaxing for me.'},
  {id:'tradition', ic:'🎎', nm:'Tradition', type:'n.', def:'Something people have done for a long time and still do.', ex:'Playing cards with family on weekends is a tradition in her house.'}
];
const VOCAB_FILL = [
