...
function renderS5(){
  ...
  <p class="section-sub">Read where the guest is in the conversation, then pick which kind of language fits that moment. Get it right and you'll see the exact phrases to use.</p>
  <div class="panel">
...
function wireS5(){
  ...
  choicesEl.addEventListener('click', e=>{
    ...
    if(isCorrect){
      ...
      btn.classList.add('wrong');
      fb.className = 'feedback show meh'; fb.textContent = "Not quite. Think about where the conversation is right now.";
