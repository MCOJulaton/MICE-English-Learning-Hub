...
function renderCover(){
  ...
  <div class="cover">
    ...
    <p>Unit 13: A Guest's Difficult Request. Listen to a guest's request, weigh your options against policy, and decide, alone, then defend it with a partner.</p>
    <div class="signdock">
...
function renderS8(){
  ...
  <p class="section-sub">Now work with a partner. Student A is the Guest Relations Coordinator; Student B is the guest. Switch roles for Round 2.</p>
  <div class="panel">
    <div class="tabs">
      <button class="tab-btn active" data-role="staff">Round 1: Guest Relations Coordinator</button>
      <button class="tab-btn" data-role="visitor">Round 2: Guest</button>
    </div>
