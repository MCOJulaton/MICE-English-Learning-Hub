...
function renderS5(){
  ...
  <p class="section-sub">The phrases wellness professionals use across the whole guest day.</p>
  <div class="panel">
...
function renderS8(){
  ...
  <p class="section-sub">Practice the full day in pairs. Student A is the Wellness Coordinator; Student B is Ms. Renner. Switch roles for Round 2.</p>
  <div class="panel">
    <div class="tabs">
      <button class="tab-btn active" data-role="staff">Round 1: Wellness Coordinator</button>
      <button class="tab-btn" data-role="visitor">Round 2: Ms. Renner</button>
    </div>
