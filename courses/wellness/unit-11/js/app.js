...
function renderCover(){
  ...
  <div class="cover">
    ...
    <h1>One reaction. <span>What really happened?</span></h1>
    <p>Unit 11: The Guest Who Didn't Feel Well. Work in a group, read the evidence, and find the real root cause together, not just a quick apology.</p>
    <div class="signdock">
...
function renderS1(){
  ...
  <h2 class="section-title">A Guest Feels Uncomfortable</h2>
  ...
  <div class="panel">
    ...
    <p class="section-sub" style="margin-top:4px;">Before the problem happens, listen to today's spa readiness briefing. Fill in the table as you listen, then reveal the answers to check yourself.</p>
...
function renderS2b(){
  ...
  <p class="section-sub">A colleague wrote this draft summary of the guest reaction investigation. One line is wrong. Click it.</p>
  <div class="panel">
...
function renderS5(){
  ...
  <p class="section-sub">Read where the investigation into Ms. Fontaine's reaction is at, then pick which kind of language fits that moment. Get it right and you'll see the exact phrases to use.</p>
  <div class="panel">
...
function wireS5(){
  ...
  choicesEl.addEventListener('click', e=>{
    ...
    if(isCorrect){
      ...
      btn.classList.add('wrong');
      fb.className = 'feedback show meh'; fb.textContent = "Not quite. Think about what stage of the investigation this is.";
...
function renderS8(){
  ...
  <p class="section-sub">Work in a group of 3. Each person takes one role below and performs the exchange together: the Investigator reports, the Spa Manager responds, and the Guest asks a follow-up question.</p>
  <div class="panel">
...
/* ===== Spot the Error (Remember-level, replaces the crossword slot) ===== */
